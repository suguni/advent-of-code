...
fn count_neighbors((row, col): (i32, i32),
                   (rows, cols): (i32, i32),
                   grid: &Vec<i32>) -> i32 {
    [
...
####..");
        ...
        assert_eq!(count_neighbors((0, 0), (rows, cols), &grid),
                   1);
        assert_eq!(count_neighbors((0, 2), (rows, cols), &grid),
                   3);
        assert_eq!(count_neighbors((4, 1), (rows, cols), &grid),
                   6);
    }
